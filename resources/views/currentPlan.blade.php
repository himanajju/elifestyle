...
@section('content')
  ...
  <div class="container" style="
    ...
    margin-bottom: 80px;">
        ...
        <!--FREE-->
        <div class="col s12 m4 l4" ng-show="userLoged.plan_id==1">
          <div class="card">
...
<div class="col s12 m4 l4" ng-show="userLoged.plan_id==2">
          <div class="card"> 
      ...
      <li >Online Competitions<i class="tiny material-icons">cancel</i></li>
            ...
            <div class="card-action" ng-show="userLoged.fname!=null">
              <a href="#plan" class="modal-trigger" ng-click="subscriPlan(2)" ng-hide="userLoged.plan_id==2">Subscribed</a>
            </div>
...
<div class="col s12 m4 l4" ng-show="userLoged.plan_id==3">
          <div class="card">
      ...
      <li >Online Competitions<i class="tiny material-icons">cancel</i></li>
            ...
            <div class="card-action"  ng-show="userLoged.fname!=null" ng-hide="userLoged.plan_id==3">
...
<div class="col s12 m4 l4" ng-show="userLoged.plan_id==4">
          <div class="card">
      ...
      <li >Online Competitions<i class="tiny material-icons">cancel</i></li>
            ...
            <div class="card-action" ng-show="userLoged.fname==null" ng-hide="userLoged.plan_id==4">
              <a href="{{url('/login')}}" class="modal-trigger">Subscribed</a>
            </div>
          </div>
        </div>
